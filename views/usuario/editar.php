                ...
                <article class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group <?php echo (isset($usuario_info['cargo']['class'])) ? $usuario_info['cargo']['class'] : ''; ?>">
                            ...
                            <input type="text" name="nCargo" id="iCargo" class="form-control"  placeholder="Exemplo: Administrador" value="<?php echo isset($usuario['cargo_usuario']) ? $usuario['cargo_usuario'] : ""; ?>"/>
                        </div>
